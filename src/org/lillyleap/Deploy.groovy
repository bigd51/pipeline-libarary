package org.lillyleap;
    ...
    def deployBuild(
        ...
        withEnv(["PATH+reset=/usr/local/bin:/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/sbin:/opt/deploy/bin:/home/darnellh/.local/bin:/home/darnellh/bin:/opt/deploy/bin"]) {
